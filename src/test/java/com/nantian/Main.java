...
//        System.out.println(2000000/(end - start));
    ...
    public static void createTable() {
        ...
        jdbcConfig.setUserId("gpp");
        jdbcConfig.setPassword("gpp");
...
//        generator.setDefaultSchema("gpp");
...
//        generator.addTable(new Table("SYS_OPERAT_LOG").setColumnOverride("CREATION_TIME", "TIMESTAMP"));
        generator.addTable(new Table("SYS_POST_APPOINTMENT").setColumnOverride("CREATE_TIME", "TIMESTAMP").setColumnOverride("UPDATE_TIME", "TIMESTAMP")
               .setColumnOverride("APPOINTMENT_DATE", "TIMESTAMP").setColumnOverride("DISMISSAL_DATE", "TIMESTAMP").setColumnOverride("EMPLOYMENT_DATE", "TIMESTAMP"));
